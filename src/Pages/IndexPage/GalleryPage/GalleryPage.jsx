...
function GalleryPage() {
  ...
  return (
    <div>
         ...
         <div className="AboutHeader" style={{ backgroundImage: "url('http://127.0.0.1:5500/cargo/assets/img/bg/breadcrumb_bg.jpg')" ,height:"300px",}}>
