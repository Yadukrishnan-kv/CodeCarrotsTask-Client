...
<div className="navbar-main1Nav">
  ...
  <div className={`side-menu ${isMenuOpen ? 'open' : ''}`}>
        <div className="logo-container" style={{display:"flex",fontSize:"16px"}}>
          <img src="http://127.0.0.1:5500/cargo/assets/img/logo/logo.svg" alt="Logo" className="logo" />
...
<img src="http://127.0.0.1:5500/cargo/assets/img/logo/logo.svg" alt="logo" style={{color:"#d70006"}}/>
  </div>
