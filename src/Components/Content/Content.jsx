    ...
    <div>
     <div className="maindiv">
      ...
      <div className="about__img">
              <img src="http://127.0.0.1:5500/cargo/assets/img/images/about_img01.png" alt="img" className="about__img1" />
              <img src="http://127.0.0.1:5500/cargo/assets/img/images/about_img03.png" alt="img" className="about__img2" />
              <img src="http://127.0.0.1:5500/cargo/assets/img/images/about_img02.png" alt="img" className="about__img3"  />
            </div>
      </div>
          ...
          <div className="about__review-wrap">
                  <div className="about__review-box">
                    ...
                    <div className="about__review-author">
                      <img src="http://127.0.0.1:5500/cargo/assets/img/images/author01.png" alt="img" className="about__review-author1" />
                      <img src="http://127.0.0.1:5500/cargo/assets/img/images/author02.png" alt="img" className="about__review-author1"/>
                      <img src="http://127.0.0.1:5500/cargo/assets/img/images/author03.png" alt="img" className="about__review-author1" />
                      <img src="http://127.0.0.1:5500/cargo/assets/img/images/author04.png" alt="img"  className="about__review-author1"/>
                    </div>
